...
drop table product;
create table product( p_id int primary key auto_increment, pname varchar(50), category varchar(50), location varchar(50), images varchar(50), email varchar(50) references customer(email) );

drop table image;
create table image( img_id int primary key auto_increment, link varchar(50), p_id int references product(p_id) );
